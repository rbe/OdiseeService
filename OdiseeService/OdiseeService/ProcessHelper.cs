...
namespace OdiseeService
{
    ...
    public class ProcessUtility
    {
        ...
        /// <summary>
        /// Kill all processes in a tree: kill all children of 'processId' and 'processId' itself.
        /// </summary>
        ...
        /// <summary>
        /// Find a parent process id of a certain child process.
        /// </summary>
        /// <param name="processId"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get all process ids of children of 'processId'.
        /// </summary>
        /// <param name="processId"></param>
        /// <returns></returns>
        public static int[] GetChildProcessIds(int processId)
        {
            ...
            foreach (Process proc in Process.GetProcesses())
            {
                ...
                proc.Dispose();
                if (processId == GetParentProcessId(currentProcessId))
                {
                    // Add this one
